    ...
    <div class="flex items-start justify-between mb-6">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div>
                        ...
                        <img src="./../assets/img/" alt="Aliph Marketing Logo" class="w-12 mr-2" />
                    ...
                    <div>
                        ...
                        <textarea rows="5" class="w-96 border print:border-0 p-1 rounded-md"
                            v-model="invoice.billTo"></textarea>
                    </div>
                </div>
