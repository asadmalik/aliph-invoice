<template>
  <div>
    <UContainer as="div" class="max-w-5xl p-7">
      ...
      <div class="w-full flex flex-row items-stretch justify-between gap-7">
        <UFormField label="Invoice Date" labelPlacement="top" size="xl"  >
          <UInput v-model="invoice.invoiceDate" type="date" class="w-full"/>
        </UFormField>
        <UFormField label="Invoice Date" labelPlacement="top" size="lg" >
          <UInput v-model="invoice.invoiceDate" type="date" class="w-[300px]"/>
        </UFormField>
        <UFormField label="Invoice Date" labelPlacement="top" size="xl" >
          <UInput v-model="invoice.invoiceDate" type="date" class="w-full" />
        </UFormField>
