...
export class CustomerRepository extends BaseRepository<ICustomer> {
  ...
  async addDemoCustomers(): Promise<void> {
    const demos: Omit<ICustomer, "id">[] = [
      ...
      {
        ntnCnic: "3520212345679",
        name: "Al-Habib Traders",
        provinceCode: "PB",
        address: "House 12-A, Bank Road, Lahore, Punjab",
        registrationType: "Filer",
        currency: "PKR",
          created_at: new Date().toISOString(),
          created_by: "system",
      ...
      {
        ntnCnic: "123456789",
        name: "Sindh Electronics",
        currency: "PKR",
        provinceCode: "SD",
        address: "Plot 45, University Road, Karachi, Sindh",
      ...
      },
      {
        ...
        provinceCode: "KP",
        address:
          "Sector C-2, University Town, Peshawar, Khyber Pakhtunkhwa",
        registrationType: "nonFiler",
          created_at: new Date().toISOString(),
          created_by: "system",
          updated_at: new Date().toISOString(),
      ...
      {
        ntnCnic: "6110123456789",
        name: "Balochistan Steel Mills",
        provinceCode: "BA",
        address: "Industrial Zone, Quetta, Balochistan",
        registrationType: "Filer",
        currency: "PKR",
          created_at: new Date().toISOString(),
          created_by: "system",
      ...
      {
        ntnCnic: "4220123456789",
        name: "Northern Services Co.",
        provinceCode: "PB",
        address:
          "Plot 8, Northern Bypass, Rawalpindi, Punjab",
        registrationType: "Exempt",
        currency: "PKR",
          created_at: new Date().toISOString(),
          created_by: "system",
          updated_at: new Date().toISOString(),
