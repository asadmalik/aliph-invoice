...
v-model="selectedItem" :items="items" placeholder="Search or Select an item" class="w-full"
        ...
        <div v-if="selectedItem" class="flex items-center gap-2">
          ...
          <UButton size="sm" color="info" :href="`/items/${selectedItem.id}`" icon="lucide:eye">View</UButton>
          <UButton size="sm" color="warning" :href="`/items/${selectedItem.id}/edit`" icon="lucide:pencil-line">Edit
          </UButton>
        </div>
      </div>
...
v-model="selectedCustomer" :items="customers" placeholder="Search or Select Customers"
        ...
        <div v-if="selectedCustomer" class="flex items-center gap-2">
          ...
          <UButton size="sm" color="info" :href="`/customers/${selectedCustomer.id}`" icon="lucide:eye">View</UButton>
          <UButton size="sm" color="warning" :href="`/customers/${selectedCustomer.id}/edit`" icon="lucide:pencil-line">Edit
          </UButton>
        </div>
      </div>
