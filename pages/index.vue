<template>
  <div>
    <div class="grid gap-6 grid-cols-1 md:grid-cols-2 p-10 md:gap-10 ">
      <UCard
        :ui="{
          root: 'hover:shadow-lg transition flex flex-col gap-4 space-between justify-between shadow-lg hover:shadow-xl',
      ...
      >
        <template #header>
          <UIcon
            name="i-heroicons-numbered-list-solid"
        ...
        <div
          class="h-full flex flex-col gap-2.5 justify-between flex-auto grow"
        >
          <div>Search</div>
          <USelectMenu
...
useSeoMeta({
  title: "Dashboard",
  description:
    "Manage your invoices, items, and customers efficiently.",
});
...
const cards = [
  ...
  // Credit Notes
  {
    ...
    description:
      "Issue a credit note for a previous invoice.",
    icon: "i-heroicons-plus-circle",
    cta: "New Credit",
...

  {
    title: "Settings",
    description:
      "Customize tax rates, company info and more.",
...
const selectedCustomer = ref<ICustomer | never | null>(
  null
);
...
onMounted(async () => {
  ...
  customers.value = await useCustomerRepo()
    .getAll()
    .then((customers) =>
